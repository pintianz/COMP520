...
public final class Encoder implements Visitor<String, Object> {
	...
	public Object visitMethodDecl(MethodDecl md, String arg) {
        ...
        for (ParameterDecl pd: pdl) {
        	pd.visit(this, Integer.toString(paramIdx));
        	paramIdx--;
        }
	...
	public Object visitParameterDecl(ParameterDecl pd, String arg) {
		int paramIdx = Integer.parseInt(arg);
		pd.runtimeEntity = new KnownAddress(Machine.characterSize, paramIdx);
		return null;
	}
